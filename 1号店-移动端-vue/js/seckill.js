new Vue({
    ...
    computed:{
        slide: function(){
            return "transform:translateX("+(-75*this.iter)+"px)";
        },
    },
    mounted() {
        var _ = this;
